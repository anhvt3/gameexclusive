 ...
 *
 * wiki: /docs/spec (tunable combat constants in dedicated config file POSUP requirement)
 * Every tunable balance number lives here so phase-test rebalance can land without
 * touching core combat logic. Resolver / Pet / Hero formulas import from this file.
 */
